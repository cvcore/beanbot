...
from beanbot.ledger.text_editor import TextEditor, ChangeSet, ChangeType
...
class TestTextEditor:
    ...
    def test_insertion(self):
        ...
        input_file = "data/file_editor/test_file.txt"
        expect_file = "data/file_editor/test_insert_expect.txt"
    ...
    def test_deletion(self):
        ...
        input_file = "data/file_editor/test_file.txt"
        expect_file = "data/file_editor/test_delete_expect.txt"
    ...
    def test_rel_deletion(self):
        ...
        input_file = "data/file_editor/test_file.txt"
        expect_file = "data/file_editor/test_rel_delete_expect.txt"
    ...
    def test_replace(self):
        ...
        input_file = "data/file_editor/test_file.txt"
        expect_file = "data/file_editor/test_replace_expect.txt"
    ...
    def test_append(self):
        ...
        input_file = "data/file_editor/test_file.txt"
        expect_file = "data/file_editor/test_append_expect.txt"
